...
def select_margin_bmnc_tensor_batched(
    alpha: torch.Tensor,
    beta: torch.Tensor,
    core: torch.Tensor,
    ops: torch.Tensor,
    ...
    **kwargs,
    ...
    """Performs selection and marginalization operations on a BM (Non-Canonical Form).

    This function processes a Born Machine (BM) in Non-Canonical Form by applying
